...
const prod1 = { indice:1, imagem:"../webSiteIflag/img/P1.png",
descricao:"ACER Notebook Gamer Nitro 5 AN515-55-59T4, Intel Core I5 10ª geração, 8GB, 512GB SDD, NVIDIA GTX 1650, Windows, preto, 15.6 Polegadas",
quantidade:1,
preco:4299.99};
...
const prod2 = { indice:2, imagem:"../webSiteIflag/img/P2.png",
descricao:"Teclado E Mouse Gamer C/ Fio Detalhes Azuis Multilaser-tc195 Marca: Multilaser  R$ 89,90",
quantidade:1,
preco: 89.90};
...
somaTotal(prod2);
//-----------------------------------------------------------
const prod3 = { indice:3, imagem:"../webSiteIflag/img/P3.png",
descricao:"Cpu Completo Intel Core I5 8gb Ssd 240gb + Monitor + Kit",
quantidade:1,
preco: 1387.00};
...
somaTotal(prod3);
//-----------------------------------------------------------
const prod4 = { indice:4, imagem:"../webSiteIflag/img/P4.png",
descricao:"Base para Notebook Multi Hexa com 6 Coolers até 17 - AC282",
quantidade:1,
preco: 119.99};
...
document.querySelector(".tprodutos").insertAdjacentHTML("beforeend", `<div class="divValor${objeto.indice}"><h1 class="valor${objeto.indice}"> ${objeto.preco.toLocaleString('pt-BR', { style: 'currency', currency: 'BRL' })}</h1></div>`);   
